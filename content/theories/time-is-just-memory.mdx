...
If you actually pay attention to the present moment, with no reference to before or after, you will notice something strange. The present has no duration at all. It is not short. It is not long. It is just here. The sense that any time has "passed" requires holding a previous version of "here" alongside the current one and noticing they are different. That holding is memory. Without it, the sense of passage cannot form.
