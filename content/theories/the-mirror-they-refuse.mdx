...
There is a particular kind of person who, when something goes wrong, always has a culprit ready, and the culprit is always someone else. The pattern is so consistent that you eventually stop hearing it as a series of unrelated grievances and start hearing it as a single ongoing operation [2, 5]. The operation is this: a thing happened, the thing belongs to them, and they cannot afford to know that. So they hand it to you [1, 4].
...
Accepting that you did something wrong costs something specific. It costs the picture of yourself as the kind of person who would not have done that [1]. For some people that picture is load bearing. Removing it would bring down the whole structure. So the structure protects itself, automatically, the same way an immune system does, by identifying the foreign object and pushing it out [2, 4].
